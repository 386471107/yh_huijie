...
public class SearchFragment extends Fragment {
    ...
    private void initView() {
        ...
        fragments.add(TestaFragment.newInstance("测试1"));
        fragments.add(TestbFragment.newInstance("测试2"));
        fragments.add(TestaFragment.newInstance("测试3"));
        fragments.add(TestaFragment.newInstance("测试4"));
        titles.add("测试1");
        titles.add("测试2");
        titles.add("测试3");
        titles.add("测试4");
